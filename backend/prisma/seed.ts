...
async function main() {
  ...
  const portfolioItems = [
    ...
    { slug: 'guru', title: 'Gurutron', category: 'Web Design', description: 'Built a modern NEET/JEE/Board exam preparation platform with intuitive UI/UX, responsive design, and seamless student experience.', clientName: 'Gurutron', tags: ['NEET/JEE/Board Prep Platform', 'Modern UI/UX Design', 'Student-First Experience'], featured: true },
    { slug: 'scrapco', title: 'ScrapCo', category: 'Web Design', description: 'Designed and developed a scrap pickup marketplace connecting households, shops, and factories with verified vendors across multiple cities.', clientName: 'ScrapCo', tags: ['Scrap Pickup Marketplace', '4.9★ Rating', 'Multi-City Operations'], featured: true },
    { slug: 'zubilo-studio', title: 'Zubilo Studio', category: 'Web Design', description: 'Created a brand-first creative studio website with custom animations, bold visuals, and a strong portfolio showcase.', clientName: 'Zubilo Studio', tags: ['Creative Studio Website', 'Custom Animations', 'Brand-First Design'], featured: true },
    { slug: 'ezdry', title: 'EZDRY', category: 'Web Design', description: 'Built a laundry service platform with online booking, location-based service areas, and real-time order tracking.', clientName: 'EZDRY', tags: ['Laundry Service Platform', 'Online Booking System', 'Location-Based Service'], featured: true },
    { slug: 'pogotunes', title: 'PogoTunes', category: 'Web Design', description: 'Designed a fun, ad-free kids\' learning platform featuring 500+ educational videos, 50+ interactive games, and multi-language content.', clientName: 'PogoTunes', tags: ['500+ Educational Videos', '50+ Interactive Games', '100% Free & Ad-Free'], featured: true },
    { slug: 'excompany', title: 'ExCompany', category: 'Web Design', description: 'Developed a professional corporate website for a business consulting firm with clean typography, structured layouts, and strong branding.', clientName: 'ExCompany', tags: ['Corporate Website', 'Professional Branding', 'Multi-Page Platform'], featured: true },
  ];
